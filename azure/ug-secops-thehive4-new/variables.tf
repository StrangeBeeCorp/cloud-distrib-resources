...
variable "secops-data-disk-size" {
  type = string
  description = "Size in GB of TheHive data disk (Cassandra)"
}

variable "secops-storage-disk-name" {
  type = string
  description = "Attachments storage disk name"
}

variable "secops-storage-disk-size" {
  type = string
  description = "Size in GB of TheHive attachments storage disk"
}

variable "secops-index-disk-name" {
  type = string
  description = "Database index disk name"
}

variable "secops-index-disk-size" {
  type = string
  description = "Size in GB of TheHive database index disk (Lucene)"
}
