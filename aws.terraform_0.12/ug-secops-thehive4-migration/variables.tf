...
variable "secops_thehive_sg_name" {
  type = string
  description = "Name of secops TheHive security group"
}

variable "secops_alb_target_group_name_thehive" {
  type = string
  description = "Name of TheHive ALB target group"
}
...
variable "secops-thehive-data-volume_id" {
  type = string
  description = "ID of existing TheHive EBS data volume to snapshot"
}

variable "secops-thehive-attachments-volume_id" {
  type = string
  description = "ID of existing TheHive EBS attachments volume to snapshot"
}

variable "secops-thehive-index-volume_id" {
  type = string
  description = "ID of existing TheHive EBS index volume to snapshot"
}
